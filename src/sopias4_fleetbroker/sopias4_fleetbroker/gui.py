...
class GUI(GUINode):
    ...
    def connect_ui_callbacks(self):
        ...
        self.ui.pushButton_load_map.clicked.connect(self.__load_map_filepicker)
        self.ui.pushButton_load_map_manual.clicked.connect(self.__load_map_manual)
    ...
    def __load_map_manual(self):
        self.node.get_logger().info("Loading map")
        map_path = self.ui.lineEdit.text()
        self.__load_map(map_path)
        self.node.get_logger().info("Loaded map")

    def __load_map(self, map_path: str):
        if map_path == "":
    ...
    def __load_map_filepicker(self):
        """
